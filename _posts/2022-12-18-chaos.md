...
V kosmologii starého Řečka byl chaos zároveň prapůvodní prázdnotou vesmíru a také podsvětím, kde přebývali mrtví.
...
Čeká se, že předpověď nejvyjde kvůli Newtonovym zákonům.
Náhodné vnější vlivy? (plynová mračna, magnetická pole, sluneční vítr)? Ne.

Je to neodmyslitená vlastnost matematických rovnic v dynamice.
...
Chaos je však pojem, který nemůže být odtžen od zbytku dynamiky.
...
Slovo teorie může mít přinejmenším dva významy - 1) tvrzení o chování světa, záleží na tom, jak dostatečně dobře odpovídá přírodě, 2) koherentní soubor matematických znalostí s jasnou konzistentní identitou, v tomto smyslu nejsou o správnosti žádné spory.
...
existuje přirozené $n$ takové, že $$f$$ Jeho periodické orbity musí být husté
...
J.
Banks a jeho kolegové dokázali, že v nastavení obecného metrického prostoru tranzitivita a husté periodické podmínky implikují citlivost na počáteční podmínky.
...
Nejjednoduším případem atraktoru dynamických systémů jsou pevné body.
...
Podivný atraktor je zhlediska teorie chaosu nejdůležitějším atraktorem.
...
Jiné diskrétní dynamické systémy mají odpuzující strukturu nazývanou Juliovy množiny, která tvoří ranici mezi oblastmi přitažlivosti pevných bodů.
...
Např.
: dimenze roviny je 2, potřebujeme dvě souřadnice k určení bodu.
...
Mřížkovou dimenzi lze – narozdíl od Hausdorffovy dimenze – určovat pro libovolný útvar.
...
Mylná představa je, že fraktály jsou perfektně soběpodobé útvary - např.
Van Kochova vločka.
Tto útvary jsou úžasným příkladem, co fraktály jsou, ale sám Mandelbrot měl na mysli mnohem širší představu o fraktálech.
...
Zpozoroval, že soběpodobné útvary dávájí základ pro modelování pravidelnostiv některých formách členitosti.
...
Budeme je používat pro generování instrukcí pro kleslení, budeme pořád dokola přepisovat stringy a písmena rekurzivně
...
Základem je rovnice:
rovnice
kde z a c jsou komplexní čísla, přičemž c je parametr charakterizující danou Juliovumnožinu.
...
Je definována jako množina komplexních čísel c, pro které 
vzorec
