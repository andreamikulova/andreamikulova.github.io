...
- 2.dnes používaný systém vyvíjí Google - Android
  ...
  - řešení: rootnutí systému, to vyžaduje reinstalaci zavaděče a poté buď přeinstalování celého systému (alternativní derivace je např. LineagOS) nebo doinstalování binárního programu se (umožňujícího získat práva root) do současného systému - v tomto stavu už se systém téměř neliší od Linuxu
