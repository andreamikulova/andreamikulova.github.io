...
### Definice funkce
**Funkce** na množine $$A \subset \R$$ je předpis, který každému číslu z množiny $$A$$ přiřazuje právě jedno reálné číslo. Množina $$A$$ se nazývá **definiční obor** funkce.
...
**Exponeniciální funkce o základu** $$a$$ je funkce na množině $$\R$$ vyjádřená ve tvaru
